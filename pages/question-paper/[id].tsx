            ...
            <table className='border-none'>
                ...
                <tbody className='border-none'>
                    <tr className='border-none'><td className='border-none'>
                        ...
                        <div className="w-fill  jodit-wysiwyg" dangerouslySetInnerHTML={{ __html: questionPaperData.bannerInstructionFirst }} />
                                ...
                                <div className="w-full" style={{ gap: '1rem', marginTop: "1rem" }}>
                                    <TextEditor
                                        customConfig={{
                                            ...
                                            "buttons": ["bold", "italic", "underline", "strikethrough", "brush", "|", "ul", "ol", "font", "fontsize", "paragraph", "lineHeight", "|", "selectall", "|", "hr", "table", "link", "symbols", "indent", "outdent", "|", { name:"Left",list: ['left', 'center', 'right', 'justify'] }, "|", "undo", "redo", "find", "fullsize", "print", "preview", "source"]
                                        }}
